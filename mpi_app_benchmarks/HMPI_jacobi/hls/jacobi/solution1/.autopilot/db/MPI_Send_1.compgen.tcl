...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    op interface \
    ports { float_clr2snd_array_4_address0 { O 9 vector } float_clr2snd_array_4_ce0 { O 1 bit } float_clr2snd_array_4_we0 { O 1 bit } float_clr2snd_array_4_d0 { O 8 vector } float_clr2snd_array_4_q0 { I 8 vector } } \
} "
} else {
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_state \
    op interface \
    ports { state_i { I 2 vector } state_o { O 2 vector } state_o_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_time_V_1 \
    op interface \
    ports { time_V_1_i { I 64 vector } time_V_1_o { O 64 vector } time_V_1_o_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    id 20 \
    name envlp_DATA_TYPE_V \
    type other \
    dir IO \
    reset_level 1 \
    sync_rst true \
    corename dc_envlp_DATA_TYPE_V \
    op interface \
    ports { envlp_DATA_TYPE_V_i { I 4 vector } envlp_DATA_TYPE_V_o { O 4 vector } envlp_DATA_TYPE_V_o_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    id 21 \
    name envlp_DATA_OR_ENVLP_s \
    type other \
    dir IO \
    reset_level 1 \
    sync_rst true \
    corename dc_envlp_DATA_OR_ENVLP_s \
    op interface \
    ports { envlp_DATA_OR_ENVLP_s_i { I 4 vector } envlp_DATA_OR_ENVLP_s_o { O 4 vector } envlp_DATA_OR_ENVLP_s_o_ap_vld { O 1 bit } } \
} "
}
