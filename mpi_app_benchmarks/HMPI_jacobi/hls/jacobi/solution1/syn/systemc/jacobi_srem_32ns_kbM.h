...
#ifndef __jacobi_srem_32ns_kbM__HH__
#define __jacobi_srem_32ns_kbM__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(jacobi_srem_32ns_kbM) {
    ...
    SC_CTOR(jacobi_srem_32ns_kbM):  ACMP_srem_seq_U ("ACMP_srem_seq_U") {
