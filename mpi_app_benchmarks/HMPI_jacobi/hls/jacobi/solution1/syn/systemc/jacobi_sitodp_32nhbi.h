...
#ifndef __jacobi_sitodp_32nhbi__HH__
#define __jacobi_sitodp_32nhbi__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(jacobi_sitodp_32nhbi) {
    ...
    SC_CTOR(jacobi_sitodp_32nhbi):  ACMP_sitodp_U ("ACMP_sitodp_U") {
