...
#ifndef __jacobi_dcmp_64ns_Ngs__HH__
#define __jacobi_dcmp_64ns_Ngs__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(jacobi_dcmp_64ns_Ngs) {
    ...
    SC_CTOR(jacobi_dcmp_64ns_Ngs):  ACMP_dcmp_comb_U ("ACMP_dcmp_comb_U") {
