...
#ifndef __jacobi_fsqrt_32nsMgi__HH__
#define __jacobi_fsqrt_32nsMgi__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(jacobi_fsqrt_32nsMgi) {
    ...
    SC_CTOR(jacobi_fsqrt_32nsMgi):  ACMP_fsqrt_U ("ACMP_fsqrt_U") {
