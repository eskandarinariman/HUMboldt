...
#ifndef __jacobi_mul_32ns_1jbC__HH__
#define __jacobi_mul_32ns_1jbC__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(jacobi_mul_32ns_1jbC) {
    ...
    SC_CTOR(jacobi_mul_32ns_1jbC):  ACMP_mul_uu_U ("ACMP_mul_uu_U") {
