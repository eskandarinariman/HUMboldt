...
#ifndef __md_faddfsub_32ns_JfO__HH__
#define __md_faddfsub_32ns_JfO__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(md_faddfsub_32ns_JfO) {
    ...
    SC_CTOR(md_faddfsub_32ns_JfO):  ACMP_faddfsub_U ("ACMP_faddfsub_U") {
