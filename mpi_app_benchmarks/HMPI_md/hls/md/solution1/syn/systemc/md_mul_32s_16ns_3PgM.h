...
#ifndef __md_mul_32s_16ns_3PgM__HH__
#define __md_mul_32s_16ns_3PgM__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(md_mul_32s_16ns_3PgM) {
    ...
    SC_CTOR(md_mul_32s_16ns_3PgM):  ACMP_mul_su_U ("ACMP_mul_su_U") {
