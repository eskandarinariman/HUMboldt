...
#ifndef __md_dcmp_64ns_64nskbM__HH__
#define __md_dcmp_64ns_64nskbM__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(md_dcmp_64ns_64nskbM) {
    ...
    SC_CTOR(md_dcmp_64ns_64nskbM):  ACMP_dcmp_comb_U ("ACMP_dcmp_comb_U") {
