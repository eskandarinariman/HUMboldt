...
#ifndef __md_mul_32ns_10ns_eOg__HH__
#define __md_mul_32ns_10ns_eOg__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(md_mul_32ns_10ns_eOg) {
    ...
    SC_CTOR(md_mul_32ns_10ns_eOg):  ACMP_mul_uu_U ("ACMP_mul_uu_U") {
