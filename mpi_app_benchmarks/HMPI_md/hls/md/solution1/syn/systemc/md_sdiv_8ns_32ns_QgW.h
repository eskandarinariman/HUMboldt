...
#ifndef __md_sdiv_8ns_32ns_QgW__HH__
#define __md_sdiv_8ns_32ns_QgW__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(md_sdiv_8ns_32ns_QgW) {
    ...
    SC_CTOR(md_sdiv_8ns_32ns_QgW):  ACMP_sdiv_seq_U ("ACMP_sdiv_seq_U") {
