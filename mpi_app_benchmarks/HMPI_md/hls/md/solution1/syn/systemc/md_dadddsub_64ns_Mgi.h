...
#ifndef __md_dadddsub_64ns_Mgi__HH__
#define __md_dadddsub_64ns_Mgi__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(md_dadddsub_64ns_Mgi) {
    ...
    SC_CTOR(md_dadddsub_64ns_Mgi):  ACMP_dadddsub_U ("ACMP_dadddsub_U") {
