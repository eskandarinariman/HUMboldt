...
#ifndef __md_srem_32ns_10nscud__HH__
#define __md_srem_32ns_10nscud__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(md_srem_32ns_10nscud) {
    ...
    SC_CTOR(md_srem_32ns_10nscud):  ACMP_srem_seq_U ("ACMP_srem_seq_U") {
