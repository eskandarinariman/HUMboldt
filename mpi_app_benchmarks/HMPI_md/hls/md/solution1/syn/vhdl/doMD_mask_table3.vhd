...
entity doMD_mask_table3_rom is 
    generic(
             dwidth     : integer := 52; 
             awidth     : integer := 6; 
             mem_size    : integer := 64
...
architecture rtl of doMD_mask_table3_rom is 
...
architecture arch of doMD_mask_table3 is
    component doMD_mask_table3_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    doMD_mask_table3_rom_U :  component doMD_mask_table3_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
