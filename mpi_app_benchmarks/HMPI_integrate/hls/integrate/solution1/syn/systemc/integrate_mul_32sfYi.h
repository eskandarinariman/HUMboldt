...
#ifndef __integrate_mul_32sfYi__HH__
#define __integrate_mul_32sfYi__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(integrate_mul_32sfYi) {
    ...
    SC_CTOR(integrate_mul_32sfYi):  ACMP_mul_su_U ("ACMP_mul_su_U") {
