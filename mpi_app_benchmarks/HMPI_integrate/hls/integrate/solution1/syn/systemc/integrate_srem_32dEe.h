...
#ifndef __integrate_srem_32dEe__HH__
#define __integrate_srem_32dEe__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(integrate_srem_32dEe) {
    ...
    SC_CTOR(integrate_srem_32dEe):  ACMP_srem_seq_U ("ACMP_srem_seq_U") {
